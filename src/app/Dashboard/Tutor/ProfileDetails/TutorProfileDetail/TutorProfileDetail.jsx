    ...
    <div className='w-full'>
      ...
      <form className="max-w-3xl mx-auto p-5  bg-[#f9f9fa] rounded-lg border-t-4 border-t-[#089bab] border-b-4 border-b-[#089bab]  "> 
        ...
        <div>
          ...
          <p className='text-sm mb-5 mt-2'>If you meet tutor2u <a href="#">minimum requirements, complete the registration form to register and proceed to create your profile on tutor. Fields marked with * are required to be completed.</a> </p>
        </div>
