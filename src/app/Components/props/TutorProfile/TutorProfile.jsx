    ...
    <>
      ...
      >
        <div>
          ...
          <div className="flex flex-col md:flex-row  gap-2">
            <div className="flex justify-center ">
              <Image className="h-28 w-[100%] rounded" src={aboutsideimg} alt="" />
            </div>
        ...
        <div className="flex flex-wrap justify-between md:p-2">
          ...
          <div>
            ...
            <Link
              href={'/TutorProfileDetails'}
              className="text-sm text-white font-medium bg-[#2c6777] rounded-full py-1.5 px-3 "
            >
              Book Tutor
            </Link>
          </div>
      ...
      <div className="w-full  p-4 mt-5 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8">
        <div className="flex flex-wrap border-b-2  ">
          ...
          <div className="flex items-center gap-2  ml-2 mb-2"><GoCodeReview /> <Link href={'/tutor_reviews'} className="mr-2 font-semibold text-[#2c6777]">Review</Link></div>
        ...
        <div>
          <h1 className="text-start text-[#373A3F] font-bold text-xl mt-1 mb-1">Education</h1>

          <Accordion collapseAll className="border-0">
            <Accordion.Panel>
              <Accordion.Title className="p-0">
                <h1 className="text-start text-[#373A3F] font-bold md:text-xl truncate  mt-1 mb-1">MBBS, MD, DM rheumatology</h1>
            ...
            <Accordion.Panel>
              <Accordion.Title className="p-0">
                <h1 className="text-start text-[#373A3F] font-bold md:text-xl truncate mt-1 mb-1">MBBS, MS, Mch neurosergery</h1>
            ...
            <Accordion.Panel>
              <Accordion.Title className="p-0">
                <h1 className="text-start text-[#373A3F] font-bold md:text-xl mt-1 mb-1">MBBS, MS, Mch neurosergery</h1>
